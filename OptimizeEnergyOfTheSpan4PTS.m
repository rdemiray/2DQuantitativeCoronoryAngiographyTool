function [ ControlPointsAfterOptimization, EnergyOfTheSplineAfterOptimization  ] = OptimizeEnergyOfTheSpan4PTS(ControlPoints, CompositeEnergy,IterationNumber, SplineNumber, SubSplineNumber, DeltaEnergy)
...
for i=0:1:8  % for P1
    CP1DiffForX = rem(i,3);
    CP1DiffForY = floor(i/3);
    
    CP1Index_YY = CP1Index_Y + CP1DiffForY;
    CP1Index_XX = CP1Index_X + CP1DiffForX;
    ...
    for j=0:1:8     %for P2
        ...
        for k=0:1:8     % for P3
            ...
            for m=0:1:8     % for P4
                ...
                NewSetOfControlPoints = [CP1Index_YY CP1Index_XX;
                ...
                waitbar((i*729 + j*81 + k*9 + (m+1))/6561, Waitbar, sprintf( 'Spline: %2d   SubSpline: %2d   Iteration: %2d    DeltaEnergy: %2d', SplineNumber, SubSplineNumber, IterationNumber, DeltaEnergy));
