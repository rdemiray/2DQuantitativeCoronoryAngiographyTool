function [ OptimizedControlPoints, OptimizedSplinePoints, IterationNumber ] = OptimizeGivenSplineLowLowComplexity( ControlPoints, CompositeEnergy , SplineNumber)
...
while(true)
    ...
    if (k>1)
        ...
        %if((abs(DeltaEnergy(k-1)) < 0.006) || (k >14))
